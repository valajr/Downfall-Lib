...
class Card {
    ...
    toHTML() {
        ...
        card_body.onclick = this.action;
        card_body.classList.add("card");
        card_body.classList.add(`${this.type}`);
...
class Deck {
     ...
     * @returns {array class Card} - array of cards with the given ID or a empty array in case didn't encounter a card with that type
     */
